<template>
  <el-dialog
    ...
    <el-form-item label="" prop="socialUid">
      <el-input v-model="dataForm.socialUid" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="accessToken">
      <el-input v-model="dataForm.accessToken" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="expiresIn">
      <el-input v-model="dataForm.expiresIn" placeholder=""></el-input>
    </el-form-item>
    </el-form>
    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/gamewebums/umsmember/info/${this.dataForm.id}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/gamewebums/umsmember/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
